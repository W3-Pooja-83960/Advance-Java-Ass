...
{
List<Blog> findBlogByUserId(int userId);
List<Blog> findByContents(String contents);
...
//         public int update(Blog b,int Cur_user)
//     {
//         String sql = "Update blogs set title=?,contents=?,category_id=? where user_id=? and id=?";
//         int count = jdbcTemplate.update(sql,b.getTitle(),b.getContent(),b.getCategoryId(),Cur_user,b.getId());
//         return count;
//     }
